...
#
# Fixture: examples/appearance_viewport_egress.ri
# Driver:  gui/test/visual/smoke_appearance_e2e.mjs (the ε driver)
#
...
e2e_smoke_run \
    --name run_appearance_e2e_smoke \
    --fixture examples/appearance_viewport_egress.ri \
    --driver gui/test/visual/smoke_appearance_e2e.mjs

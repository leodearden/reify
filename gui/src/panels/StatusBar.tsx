...
export interface StatusBarProps {
  ...
  /** When provided, badge buttons gain aria-expanded reflecting the expanded state of the docked panel. */
    ...
    <div data-testid="status-bar" class={styles.container} role="status" aria-live="polite">
      ...
      <Show when={(props.tessellationDiagnostics?.length ?? 0) > 0}>
        ...
        <button
          ...
          aria-expanded={props.diagnosticsCollapsed !== undefined ? !props.diagnosticsCollapsed : undefined}

...
export const DesignTreeContextMenu: Component<Props> = (props) => {
  ...
  return (
    ...
    >
      <button class={styles.contextMenuItem} onClick={() => act('show-cascade')}>
        Show this and children
      </button>
      <button class={styles.contextMenuItem} onClick={() => act('ghost-cascade')}>
        Ghost this and children
      </button>
      <button class={styles.contextMenuItem} onClick={() => act('hide-cascade')}>
        Hide this and children
      </button>
      <button class={styles.contextMenuItem} onClick={() => act('show-only')}>
        Show only this
      </button>
      <button class={styles.contextMenuItem} onClick={() => act('reset')}>
        Reset to default
      </button>
      <hr class={styles.separator} />
      <button class={styles.contextMenuItem} onClick={() => act('show-only-no-cascade')}>

; reify-gcode round-trip fixture — exercises every Marlin command kind
; the parser supports (PRD docs/prds/v0_3/trajectory-input-shaping.md
; §7.1). Comments, blank lines, and indented lines are intentional.

...
impl Default for MorphOptions {
    fn default() -> Self {
        Self {
            ...
            // produces a population skewed toward sj < 0.25 (plate base
            // pct ≈ 0.91 at hole_diameter = 0.30; box pct ≈ 0.57 at n=4).
            // At 0.95 the fixtures' intrinsic populations pass; morph

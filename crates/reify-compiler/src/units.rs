...
mod tests {
    ...
    // registry level. Eval-side dispatch is deferred to task 2691.
    //
    //   - `edges(solid)`                          → List<Geometry>
    //   - `faces(solid)`                          → List<Geometry>
    //   - `edges_by_length(solid, range)`         → List<Geometry>
    //   - `faces_by_area(solid, range)`           → List<Geometry>
    //   - `faces_by_normal(solid, dir, tol)`      → List<Geometry>
    //   - `edges_parallel_to(solid, dir, tol)`    → List<Geometry>
    //   - `edges_at_height(solid, h, tol)`        → List<Geometry>
    //   - `adjacent_faces(solid, face)`           → List<Geometry>
    //   - `shared_edges(face1, face2)`            → List<Geometry>
    //   - `center_of_mass(solid, density)`        → Point3<Length>
    //   - `moment_of_inertia(solid, density)`     → Tensor<2, 3, MomentOfInertia>

    #[test]
    fn is_geometry_topology_selector_recognises_edges() {
        assert!(is_geometry_topology_selector("edges"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_faces() {
        assert!(is_geometry_topology_selector("faces"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_edges_by_length() {
        assert!(is_geometry_topology_selector("edges_by_length"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_faces_by_area() {
        assert!(is_geometry_topology_selector("faces_by_area"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_faces_by_normal() {
        assert!(is_geometry_topology_selector("faces_by_normal"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_edges_parallel_to() {
        assert!(is_geometry_topology_selector("edges_parallel_to"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_edges_at_height() {
        assert!(is_geometry_topology_selector("edges_at_height"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_adjacent_faces() {
        assert!(is_geometry_topology_selector("adjacent_faces"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_shared_edges() {
        assert!(is_geometry_topology_selector("shared_edges"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_center_of_mass() {
        assert!(is_geometry_topology_selector("center_of_mass"));
    }

    #[test]
    fn is_geometry_topology_selector_recognises_moment_of_inertia() {
        assert!(is_geometry_topology_selector("moment_of_inertia"));
    }

    #[test]
    fn topology_selector_result_type_edges_is_list_geometry() {
        assert_eq!(
            topology_selector_result_type("edges"),
            Some(reify_types::Type::List(Box::new(reify_types::Type::Geometry)))
        );
    }

    #[test]
    fn topology_selector_result_type_faces_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_edges_by_length_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_faces_by_area_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_faces_by_normal_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_edges_parallel_to_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_edges_at_height_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_adjacent_faces_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_shared_edges_is_list_geometry() {
        assert_eq!(
    ...
    #[test]
    fn topology_selector_result_type_center_of_mass_is_point3_length() {
        assert_eq!(
            topology_selector_result_type("center_of_mass"),
            Some(reify_types::Type::point3(reify_types::Type::length()))
        );
    }

    #[test]
    fn topology_selector_result_type_moment_of_inertia_is_tensor_2_3_moment_of_inertia() {
        assert_eq!(
            topology_selector_result_type("moment_of_inertia"),
            Some(reify_types::Type::tensor(
                2,
                3,

...
// ─── task #5582: mirror-reintroduction gate over the m8_tolerancing lineage ──
//
// Hosted here rather than as a standalone crates/reify-compiler/tests/
// tolerancing_mirror_gate.rs binary: that layout is a C1 re-accretion
// violation (PRD docs/prds/merge-gate-compile-cost.md §5 C1/C2, enforced by
...
mod mirror_gate {
    ...
    //! durable signal is structural-but-behavioural, and is what this module gates:

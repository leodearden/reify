...
///
/// Delegates to [`get_let_expr_in`] using the name of the first template in the module.
...
fn get_let_expr_in<'a>(
    ...
    let cell = template
        ...
        .unwrap_or_else(|| panic!("no value cell named '{cell_name}' in template '{template_name}'"));
    cell.default_expr
        .as_ref()

...
use reify_ir::{
    AttributeHistory, BooleanOpHistoryRecords, LocalFeatureOpHistoryRecords, LoftOpHistoryRecords,
...
fn boolean_silent_drop_emits_one_warning() {
    ...
    assert!(
        d.message.to_lowercase().contains("bool") || d.message.to_lowercase().contains("boolean"),

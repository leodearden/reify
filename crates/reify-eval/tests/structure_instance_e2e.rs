...
// The SIR-α user-observable CLI golden (step-23,
// cli_reify_eval_prints_inspectable_structure_values) now lives in
// crates/reify-cli/tests/harness_cli/cli_structure_instance_golden.rs, where

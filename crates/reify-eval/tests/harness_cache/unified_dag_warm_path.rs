...
//! and reached here via `use crate::differential::…`, so this module reuses all
//! corpus helpers with zero edits to existing shared files.
...
use reify_ir::{ExportFormat, GeometryHandleId, GeometryKernel, Value};

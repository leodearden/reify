...
|---|---|---|---|
| 2347 (stdlib-trait-audit doc stale) | findings/stdlib-trait-breadth.md M-002 | **3487 → 3529 (COMPLETED 2026-05-14)** | Renamed to `docs/notes/stdlib-trait-breadth-audit-v01.md` (matches PRD); refreshed with DONE markers + task/commit refs (2349/bc5c2d69aa, 2352/b3429254e3, 2354); still-open items flagged; cross-link to `materials_mechanical.ri:32-38` Trait Resolution Policy added |

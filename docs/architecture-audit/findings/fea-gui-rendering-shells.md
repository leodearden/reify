...
- **`structural-analysis-fea.md` (v0.3)** owns ElasticResult, the engine integration (#2924, pending with 14 prereqs), the `@optimized` + ComputeNode dispatch. Transitive GR-001 (struct-ctor eval) blocker via 3378.

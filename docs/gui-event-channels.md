...
| `tensegrity-wires-update` | `Vec<TensegrityWireData>` (full list) | `delta_to_events` | `onTensegrityWiresUpdate` | Full-snapshot semantics |
| `tensegrity-surfaces-update` | `Vec<TensegritySurfaceData>` (full list) | `delta_to_events` | `onTensegritySurfacesUpdate` | Full-snapshot semantics |
| `display-panes-update` | `Vec<DisplayDirective>` (full list) | `delta_to_events` | `onDisplayPanesUpdate` | Full-snapshot semantics |
| `display-appearance-update` | `Vec<AppearanceDirective>` (full list) | `delta_to_events` | `onDisplayAppearanceUpdate` | Full-snapshot semantics |

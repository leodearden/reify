...
| INV-BUILD-3 | A cache-hit short-circuit produces the same observable side-effect set as the path it short-circuits | test (extracted `probe_realization_cache` + parity tests) | enforced(test) | engine-build-hardening |

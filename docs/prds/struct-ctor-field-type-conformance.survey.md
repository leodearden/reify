...
**Base commit:** `a0d0899874e00fb78d50e2e6b1d7834117a0a2de`
...
| `tests/prd-gate/fixtures/stdlib_ns_qualified_expr.ri` | `parse-error` |
| `tests/prd-gate/fixtures/stdlib_ns_qualified_type.ri` | `parse-error` |
...
| `tests/prd-gate/fixtures/unit_curated_labels_ascii.ri` | `compile-error` |

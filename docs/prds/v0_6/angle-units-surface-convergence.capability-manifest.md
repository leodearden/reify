...
| the exemplar corpus + its bidirectional gate | `examples/best_practices/` (7 files incl. `INDEX.md`, `bolt_circle.ri`); `INDEX.md:53` bolt_circle row; gate `crates/reify-compiler/tests/examples_smoke.rs` | PASS |

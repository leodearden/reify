...
| the deliberate `Int`-leniency pin to restate (not merely delete) exists | `grep:crates/reify-compiler/tests/harness_statement_semantics/constraint_def_compile_tests.rs:1499-1522` `int_literal_for_length_param_no_constraint_arg_type_mismatch`, whose doc comment states the leniency as **intent** | PASS |

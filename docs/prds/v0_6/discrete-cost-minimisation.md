...
- **α — Let-tracing: transitive constraint↔auto closure + shared per-trial dependent-cell fold.** ~~registry sub-problems get real `dependent_cells`, replacing `registry.rs:244`'s `Vec::new()`~~ **LANDED 2026-08-03/04 (#5189, #5720, #5954, #5467) — verified in-tree 2026-08-25.**

...
| `pipe()` non-+Z paths | DONE #5343 (landed 2026-07-29) — `pipe()` accepts any finite start-tangent orientation | `crates/reify-ir/src/geometry.rs:834–853` (`GeometryOp::Pipe` doc) |

...
- **κ #6768 — Uncoded-diagnostics ratchet (D8).** Fingerprint gen binary, seeded baseline (~700 rows), shrink-only gate. *Signal:* a new uncoded emission site reds the gate naming path+context.
